...
`yobirin ps` で、いま結果を待っている通知プロセスを一覧できる (`--timeout` を付け忘れた放置通知の発見に便利)。`--json` で機械可読な出力になる:
...
(default)  com.mjun0812.yobirin         0.4.0    /Users/you/Applications/Yobirin.app
claude     com.mjun0812.yobirin.claude  0.4.0    /Users/you/Applications/Yobirin-Claude.app
```
